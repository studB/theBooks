// ============================================================
// theBooks — File list (workspace-based)
// ============================================================
...
function FileList({
  ...
  const [sort, setSort] = useStateF('updated');
  const [renamingId, setRenamingId] = useStateF(null);
  const [renameVal, setRenameVal] = useStateF('');
