// ============================================================
// theBooks — Reference pane (read-only secondary file)
// ============================================================

const { useState: useStateR, useEffect: useEffectR, useMemo: useMemoR } = React;

function ReferencePane({ file, onClose, onSwap, onChangeFile, items, workspaceId, splitWidth }) {
  const [pickerOpen, setPickerOpen] = useStateR(false);

  // Other files in workspace (everything except current ref)
  const others = useMemoR(() => {
...
window.ReferencePane = ReferencePane;
window.SplitDivider = SplitDivider;
